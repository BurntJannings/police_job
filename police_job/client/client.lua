...
Citizen.CreateThread(function() -- custom edit 
    while true do
        ...
        if jailed then 
            ...
            local currentCheck = Vdist(coords.x, coords.y, coords.z, 3342.04, -691.30, 43.88)
            local broom = Vdist(GetHashKey("p_broom01x"), coords.x, coords.y, coords.z)
...
Citizen.CreateThread(function() -- custom edit 
    while true do
        Wait(10)
        if jailed then 
            local blip = N_0x554d9d53f696d002(1664425300,3343.25, -692.97, 43.84)
...
RegisterNetEvent("lawmen:breakout")
...
RegisterNetEvent("police_job:wear_prison")
